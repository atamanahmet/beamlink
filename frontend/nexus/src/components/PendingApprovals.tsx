...
import { useAgent, type Agent } from "../context/AgentContext";
...
export const PendingApprovals = () => {
  ...
  const [pendingRenames, setPendingRenames] = useState<Agent[]>([]);
          ...
          >
            <div>
              ...
              <div className="space-y-1 text-sm text-orange-300/60">
                ...
                <p>Requested At: {formatDate(agent.renameRequestedAt ?? "")}</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {pendingRenames.map((rename) => (
                ...
                >
                  <div>
                    <h3 className="text-lg font-bold text-orange-300 mb-1">
                      {rename.name} → {rename.requestedName}
                    </h3>
                    <div className="space-y-1 text-sm text-orange-300/60">
                      <p>Agent ID: {rename.id}</p>
                      <p>
                        Requested: {formatDate(rename.renameRequestedAt ?? "")}
                      </p>
                    </div>
                  </div>
