...
import com.atamanahmet.beamlink.agent.service.FileTransferService;
...
public class FileController {
    ...
    /**
     * Check if there's enough disk space before uploading
     */
    ...
    /**
     * Upload endpoint - receives files via MultipartFile and streams to disk
     */
    @PostMapping("/upload")
    public ResponseEntity<Map<String, Object>> upload(
        ...
        // Validate filename (already checked in pre-flight)
        if (filename == null || filename.trim().isEmpty()) {
            response.put("success", false);
            response.put("error", "Invalid filename");
    ...
    /**
     * Ping endpoint - check if agent is online
     */
    @GetMapping("/ping")
